...
console.log('task 8 :', artistInfo(artists, 'Frido Kahlo'));
...
function artistByCountry(array, nationalitySearch){
  const nationalityGroup = [];
  for(let i=0;i<array.length;i++){
    if(array[i].nationality === nationalitySearch){
      nationalityGroup.push(array[i].name);
    }
